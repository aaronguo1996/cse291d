...
happyExpList = Happy_Data_Array.listArray (0,26) ([1312,164,2,20992,2624,0,8196,2053,2049,0,82,0,16384,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_typeParser","TypeExpr","Exp1","var","','","\"->\"","'['","']'","'('","')'","%eof"]
        bit_start = st * 13
        bit_end = (st + 1) * 13
...
action_12 (5) = happyGoto action_7
...
typeParser tks = happyRunIdentity happySomeParser where
